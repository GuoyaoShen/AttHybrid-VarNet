...
path_dir_train = 'C:/TortoiseGitRepos/data/fastmri/knee_singlecoil_train_full/'
path_dir_test = 'C:/TortoiseGitRepos/data/fastmri/knee_singlecoil_val_full/'
bhsz = 1
# training settings
NUM_EPOCH = 50
learning_rate = 1e-3
# save settings
PATH_MODEL = './saved_models/fastmri/hybridvarnet_knee_'+str(acc)+'x_E'+str(NUM_EPOCH)+'.pt'
PATH_CKPOINT = './saved_models/fastmri/hybridvarnet_knee_'+str(acc)+'x_E'+str(NUM_EPOCH)+'_ck.pt'
